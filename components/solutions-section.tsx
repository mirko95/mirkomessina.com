...
export function SolutionsSection({ locale = "en" }: { locale?: Locale }) {
  ...
  return (
    <section id="solutions" className="relative py-24 lg:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(168,85,247,0.035),transparent_42%),radial-gradient(circle_at_top_right,rgba(59,130,246,0.03),transparent_40%),radial-gradient(circle_at_bottom,rgba(2,6,23,0.08),transparent_48%)]" />
